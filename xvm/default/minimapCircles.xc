 ...
 */
{
  "circles": {
    ...
    "view": [
      // Main circles:
      // Основные круги:
      { "enabled":  true, "distance": "blindarea", "scale": 1, "thickness": 0.7, "alpha": 80, "color": "0x3EB5F1" },
      { "enabled":  true, "distance": 445,         "scale": 1, "thickness":  0.7, "alpha": 45, "color": "0xFFCC66" },
      ...
      { "enabled": true, "distance": 50,           "scale": 1, "thickness": 0.7, "alpha": 35, "color": "0xFFFFFF" },
